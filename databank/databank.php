...
class H3Effect extends Effect {
  ...
  //> retreatCan bool `- possibility for fleeing, for combat hero and for ADVMAP monster (XXX=I) before combat (this happens after check for 'creature_join')
...
class Creature extends StoredEntity {
  ...
  static $unrolled = [];
  static $compact = ['effects' => 'H3Effect', 'effectsTown' => 'H3Effect', 'effectsHero' => 'H3Effect', 'passable' => 'intval'];
...
class Building extends StoredEntity {
  ...
  static $unrolled = [];
  static $compact = ['effects' => 'H3Effect', 'image' => 'BuildingImage', 'imageU' => 'BuildingImage'];
