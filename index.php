...
<html>
  ...
  <body class="<?=$minified ? 'HLb_ HLb_static' : ''?>">
    ...
    <noscript>
      <p>HeroWO is a purely JavaScript game. Please enable JavaScript in order to play it!</p>
    </noscript>
    ...
    <?php } else {?>
      ...
      <?php if (!keyValue('production')) { // see Browser.js ?>
    ...
    <?php if ($minified) {?>
      <script async src="<?=htmlspecialchars($timeRef('herowo.min.js'))?>"></script>
    <?php } else {?>
      ...
      <script async data-main="client/config" src="client/r.js/require.js"></script>
    <?php }?>
